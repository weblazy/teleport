...
[简体中文](https://github.com/lazyweb/teleport/tree/master/README_ZH.md)
...
[More Examples](https://github.com/lazyweb/teleport/tree/master/examples)
...
| package                                  | import                                   | description                              |
| ---------------------------------------- | ---------------------------------------- | ---------------------------------------- |
| [rawproto](https://github.com/lazyweb/teleport/tree/master/proto/rawproto) | `"github.com/lazyweb/teleport/proto/rawproto` | A fast socket communication protocol(teleport default protocol) |
| [jsonproto](https://github.com/lazyweb/teleport/tree/master/proto/jsonproto) | `"github.com/lazyweb/teleport/proto/jsonproto"` | A JSON socket communication protocol     |
| [pbproto](https://github.com/lazyweb/teleport/tree/master/proto/pbproto) | `"github.com/lazyweb/teleport/proto/pbproto"` | A Protobuf socket communication protocol     |
| [thriftproto](https://github.com/lazyweb/teleport/tree/master/proto/thriftproto) | `"github.com/lazyweb/teleport/proto/thriftproto"` | A Thrift communication protocol     |
| [httproto](https://github.com/lazyweb/teleport/tree/master/proto/httproto) | `"github.com/lazyweb/teleport/proto/httproto"` | A HTTP style socket communication protocol     |
...
Teleport is under Apache v2 License. See the [LICENSE](https://github.com/lazyweb/teleport/raw/master/LICENSE) file for the full license text
